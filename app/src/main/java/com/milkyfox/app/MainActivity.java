...
import com.milkyfox.app.interstitial.InterstitialSataticAdapterActivity;
...
import com.milkyfox.app.rewarded_video.test.RewardedVideoActivityTest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuElements.add(new MenuElement(getString(R.string.interstitial_static_adapter), InterstitialSataticAdapterActivity.class));
        ...
        menuElements.add(new MenuElement(getString(R.string.rewarded_video_test), RewardedVideoActivityTest.class));
