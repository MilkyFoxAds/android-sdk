...
public class InterstitialActivityTest extends AppCompatActivity {
    ...
    private void load() {
        ...
        RequestManager.getInstance(this).loadInterstitial(
    ...
    private class InnerRequestListener extends BaseRequestListener<LoadInterstitialSuccessResponse> {
        ...
        public void success(final LoadInterstitialSuccessResponse response) {
            ...
            LayoutInflater layoutInflater = LayoutInflater.from(InterstitialActivityTest.this);
            for(BaseAdData baseAdData:response.mList){
                View view = layoutInflater.inflate(R.layout.controller, null);
                ControllerWrapper controllerWrapper = new ControllerWrapper(view, baseAdData, InterstitialActivityTest.this);
        ...
        public void error(final ErrorResponse response) {
            ToastHelper.showToast(InterstitialActivityTest.this, "fail");
        }
